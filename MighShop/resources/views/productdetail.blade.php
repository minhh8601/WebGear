...
<body ng-app="myapp" ng-controller="mycontroller">
    ...
    <section class="product-details spad" ng-init="getDetail()">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="/upload/sanpham/@{{sanpham.image}}" alt="">
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">@{{sanpham.unit_price|number}}</div>
                        <p>@{{sanpham.mota_sp}}</p>
                        ...
                        <a href="#" class="primary-btn" ng-click="addToCart(item)">ADD TO CARD</a>
    ...
    <section class="related-product" ng-init="getDetail()">
        <div class="container">
            <div class="row" >
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6" ng-repeat="row in sanphamcungloai">
