                            ...
                            <tbody>
                                <tr ng-repeat="item in listSP">
                                    <td class="shoping__cart__item">
                                        <img src="/upload/sanpham/@{{item.image}}" style="height:150px ;" alt="">
                                        <h5></h5>
                                    </td>
                                    <td class="shoping__cart__price">
                                        @{{item.unit_price|number}} đồng
                                    </td>
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <span class="" ng-click="changeQuantityDown($index)">-</span>
                                                <input type="text" value="1" ng-model="item.quantity">
                                                <span class="" ng-click="changeQuantityUp($index)">+</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="shoping__cart__total">
                                        @{{item.quantity*item.unit_price|number}} đồng
                                    </td>
                                    <td class="shoping__cart__item__close">
                                        <span class="icon_close" ng-click="removeCart(item)"></span>
                                    </td>
                                </tr>
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <ul>
                            ...
                            <li>Total <span>@{{getTotal()|number}} đồng</span></li>
                        </ul>
