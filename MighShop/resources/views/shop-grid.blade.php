                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="/tainghe">Tai nghe</a></li>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar__item">
                            ...
                            <div class="price-range-wrap">
                                <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content" data-min="20" data-max="200">
                ...
                <div class="col-lg-9 col-md-7">
                            ...
                            <div class="product__discount__slider owl-carousel">
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg" data-setbg="img/product/discount/Corsair 3087 luffy.jpg">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Chuột</span>
                                            <h5><a href="#">LOGITECH CHOPER</a></h5>
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg" data-setbg="public\img\product\discount\DAREU A87 SUMMER.jpg">
                                            <div class="product__discount__percent">-20%</div>
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6" dir-paginate="row in sanphams | itemsPerPage: pageSize" current-page="currentPage">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="upload/sanpham/@{{row.image}}">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart" ng-click="addToCard(item)"></i></a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="product__pagination">
                        <<dir-pagination-controls max-size='9' on-page-change="pageChangeHandler(newPageNumber)"></dir-pagination-controls>
