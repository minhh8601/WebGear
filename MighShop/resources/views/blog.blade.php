        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-5">
                    <div class="blog__sidebar">
                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <ul>
                                <li><a href="#">All</a></li>
                                <li><a href="#">Tin công nghệ (20)</a></li>
                                <li><a href="#">Khoa học (5)</a></li>
                                <li><a href="#">Thủ thuật (9)</a></li>
                                <li><a href="#">Review (10)</a></li>
                            </ul>
                        </div>
                        <div class="blog__sidebar__item">
                            <h4>Recent News</h4>
                            <div class="blog__sidebar__recent">
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="upload/news/elon1.png" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                        <h6>Elon Musk thâu tóm Twitter<br /> với giá 44 tỷ đô</h6>
                                        <span>MAR 05, 2019</span>
                                    </div>
                                </a>
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="upload/news/KTPhone1.png" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                        <h6>Kingston ra mắt SSD di động<br /></h6>
                                        <span>MAR 05, 2019</span>
                                    </div>
                                </a>
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="upload/news/Huawei1.png" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                        <h6>Huawei đầu tư vào công nghệ <br />xếp chồng chip 3D</h6>
                                        <span>MAR 05, 2019</span>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="col-lg-8 col-md-7" >
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6" dir-paginate="row in newss | itemsPerPage: pageSize" current-page="currentPage">
                            <div class="blog__item">
                                <div class="blog__item__pic">
                                    <img src="upload/news/@{{row.image}}" alt="">
                                </div>
                                <div class="blog__item__text">
                                    ...
                                    <p></p>
                                    <a href="/blog-details/@{{row.id}}" ng-click="openDetail(row.id)" class="blog__btn">READ MORE <span class="arrow_right"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <dir-pagination-controls max-size='8' on-page-change="pageChangeHandler(newPageNumber)"></dir-pagination-controls>
