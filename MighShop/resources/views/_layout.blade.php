                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="#">
                                ...
                                <input type="text" ng-model='q'  placeholder="What do yo u need?" >
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".oranges">Bàn phím Gaming</li>
                            <li data-filter=".fresh-meat">Tai nghe Gaming</li>
                            <li data-filter=".vegetables">Chuột Gaming</li>                          
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row featured__filter"  >
                <div class="col-lg-3 col-md-4 col-sm-6 oranges " dir-paginate="row in sanphams | filter:q | itemsPerPage: pageSize" current-page="currentPage">
                ...
                <!-- chuot -->
                <!-- <div class="col-lg-3 col-md-4 col-sm-6 vegetables" ng-repeat="row in chuots|filter:'Chuột'">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="upload/sanpham/@{{row.image}}">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
